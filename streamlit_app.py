...
with credit_hist:
    ...
    #Bill Amount
    BILL_AMT1 = bill.number_input("Bill Amount (Current Month)", min_value=-2, max_value=10000000, value=None, step=100, placeholder="Bill Amount")
    BILL_AMT2 = bill.number_input("Bill Amount (1 Month Ago)", min_value=-2, max_value=10000000, value=None, step=100, placeholder="Bill Amount")
    BILL_AMT3 = bill.number_input("Bill Amount (2 Month Ago)", min_value=-2, max_value=10000000, value=None,step=100, placeholder="Bill Amount")
    BILL_AMT4 = bill.number_input("Bill Amount (3 Month Ago)", min_value=-2, max_value=10000000, value=None,step=100, placeholder="Bill Amount")
    BILL_AMT5 = bill.number_input("Bill Amount (4 Month Ago)", min_value=-2, max_value=10000000, value=None,step=100, placeholder="Bill Amount")
    BILL_AMT6 = bill.number_input("Bill Amount (5 Month Ago)", min_value=-2, max_value=10000000, value=None,step=100, placeholder="Bill Amount")

    #Payment Amount
    PAY_AMT1 = pay.number_input("Payment Amount (Current Month)", min_value=-2, max_value=10000000, value=None,step=100, placeholder="Payment Amount")
    PAY_AMT2 = pay.number_input("Payment Amount (1 Month Ago)", min_value=-2, max_value=10000000, value=None,step=100, placeholder="Payment Amount")
    PAY_AMT3 = pay.number_input("Payment Amount (2 Month Ago)", min_value=-2, max_value=10000000, value=None,step=100, placeholder="Payment Amount")
    PAY_AMT4 = pay.number_input("Payment Amount (3 Month Ago)", min_value=-2, max_value=10000000, value=None,step=100, placeholder="Payment Amount")
    PAY_AMT5 = pay.number_input("Payment Amount (4 Month Ago)", min_value=-2, max_value=10000000, value=None,step=100, placeholder="Payment Amount")
    PAY_AMT6 = pay.number_input("Payment Amount (5 Month Ago)", min_value=-2, max_value=10000000, value=None,step=100, placeholder="Payment Amount")
